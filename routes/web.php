...
Route::get('frontend/Chi_Tiet_San_Pham/Details_Product/{Productid}','ProductController@details_product');
//Route::post('frontend/Chi_Tiet_San_Pham/{Productid}', 'ProductController@postComment')->name('comment');

//tin-tuc
Route::get('frontend/tin_tuc/tin_tuc','TinTucController@index');
Route::get('frontend/tin_tuc/ct_tin_tin_tuc/{id}','TinTucController@show');
