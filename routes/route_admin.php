<?php
    ...
    //Dùng cho Admin-Comment

    Route::get('admin/comment/cmt-list','CommentController@Commentlist');
    route::get('admin/comment/delete_Comment/{id}','CommentController@delete_Comment');


    //Dùng cho Admin-Slider
    Route::get('admin/slider/slider-manage','SliderController@slider_manage');
    Route::get('admin/slider/slider-add','SliderController@slider_add');
    Route::get('admin/slider/delete-slide/{Sliderid}','SliderController@delete_slider');
    Route::post('admin/slider/insert-slider','SliderController@insert_slider');
    Route::get('admin/slider/unactive-slide/{Sliderid}','SliderController@unactive_slider');
    Route::get('admin/slider/active-slide/{Sliderid}','SliderController@active_slider');

    //Dùng cho Admin-Tin_tuc
    Route::get('admin/tin_tuc/list-tin-tuc','AdminTinTucController@New_List');
    route::get('admin/tin_tuc/delete_TinTuc/{id}','AdminTinTucController@delete_New');
    Route::get('admin/tin_tuc/add-tin-tuc','AdminTinTucController@Add_New');
    Route::post('admin/tin_tuc/add-tin-tuc','AdminTinTucController@store');

    Route::get('admin/tin_tuc/sua/{id}','AdminTinTucController@SuaTinTuc');
    Route::post('admin/tin_tuc/sua/{id}','AdminTinTucController@postSuaTinTuc');
