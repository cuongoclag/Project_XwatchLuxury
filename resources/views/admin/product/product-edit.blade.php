            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="{{URL::to('/admin/product/update_product/'.$ep->Productid)}}" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="txtProductimages" class="form-control">
                            </div>
                            <div class="form-group">
