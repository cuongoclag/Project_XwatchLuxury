                ...
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <label>Status</label>
                                <input type="checkbox" class="form-control" name="txtStatus" value="1"></input>
                            </div>
                            <div class="form-group">
                                <label>Hot</label>
                                <input type="checkbox" class="form-control" name="txtHot" value="1"></input>
                            </div>
                            <div class="form-group">
                                <label>Mô Tả Sản Phẩm</label>
                                <textarea class="form-control" rows="3" name="txtProductDescription" required></textarea>
                            </div>
