...
<form method="post" action="{{route('getlogin_admin')}}" id="form-login">
@csrf
  <h1 id="litheader">XwatchLuxury</h1>
  <div class="inset">
    <p>
    <input type="text" name="username" id="user_input" placeholder="Username " />
    </p>
    <p>
