                        ...
                        <div class="add-to-cart">
                            ...
                            <?php 
                                ...
                                foreach($content as $v_content){
                                    if($v_content->id == $dp->Productid && $v_content->qty == 2){
                                        $null = 1;
                                    }
                                }
                            ?>
                    ...
                    <div class="col-md-12" style="text-align:center;">
                        ...
                        <div id="review-form">
                            <form class="review-form" method="post" action="{{route('comment')}}">
                                @csrf
                                <input class="hidden" type="text" name="Customerid"
                                    value="{{Session::get('khach_hang_dn')->Customerid}}">
                                <input class="hidden" type="text" name="Customername"
                                    value="{{Session::get('khach_hang_dn')->Customername}}">
                                @foreach($details_product as $key => $dp)
                                <input class="hidden" type="text" name="Productid" value="{{$dp -> Productid}}">
                                @endforeach
                                <input class="input" type="text" name="ndcomment" id="ndcomment"
                        ...
                        <div id="review-form" style=" margin: 3% 0 !important;">
                            ...
                            <a href="{{route('getlogin')}}" class="cn c_white"
                                style="color: red; margin: 10px 0px !important;"><i class="fa fa-user cn c_white"></i>
                                Đăng nhập tại đây</a>
                        </div>
                        @endif
                        @endif
                                ...
                                <div class="col-sm-10">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <strong>{{$cmt -> Customername}}</strong> <span class="text-muted">commented
                                                5 days ago</span>
                                        </div>
